...
<head>
    ...
    <title>Contiplan | @yield('titlepage')</title>
    ...
    <meta property="og:image" content="{{ asset('img/metaphoto.png') }}">
    ...
    <meta property="twitter:image" content="{{ asset('img/metaphoto.png') }}">
